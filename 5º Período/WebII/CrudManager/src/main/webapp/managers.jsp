...
<title>CRUD Manager - Gerentes</title>
</head>
<body>
	...
	<div id="container" class="container-fluid">
		...
		<div id="top" class="row">
			...
			<div class="col-md-6">
				<div class="input-group h2">
					<input name="data[search]" class="form-control" id="search"
						type="text" placeholder="Pesquisar gerentes"> <span
			...
			<div class="col-md-3">
				<a href="/crud-manager/manager/form"
					class="btn btn-danger pull-right h2"><span
					class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Gerente</a>
			</div>
		</div>
						...
						<c:forEach var="manager" items="${managers}">
							<tr>
								...
								<td class="actions"><a
									...
									data-manager-name="${manager.getName()}" data-toggle="modal"
		...
		$(document).ready(
				function() {
					...
					$(".modal-remove")
							.click(
									function() {
										var managerName = $(this).attr(
												'data-manager-name');
										var managerId = $(this).attr(
												'data-manager-id');
										$(".modal-body #hiddenValue").text(
												"o gerente '" + managerName
														+ "'");
										$("#id").attr("value", managerId);
										$("#form").attr("action",
												"manager/delete");
									})
				});
