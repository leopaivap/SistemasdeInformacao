			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="name">Nome</label> <input type="text"
						...
						oninput="setCustomValidity('')" value="${user.getName()}">
				</div>

				<div class="form-group col-md-4">
					<label for="gender">Sexo</label> <select id="gender"
						class="form-control selectpicker" name="gender" required
						oninvalid="this.setCustomValidity('Por favor, informe o sexo')"
						oninput="setCustomValidity('')">
						<option value="" disabled ${not emptyuser ? "" : "selected"}>Selecione
							o sexo</option>
